...
<html>
    <head>
        ...
        <meta name="description" content="l'OpenThesaurus-ca és un lloc web interactiu per a elaborar un diccionari català de sinònnims i assocacions."/>
    </head>
    <body>
...
<!-- THIS CONTENT IS SPECIFIC TO OPENTHESAURUS-CA -->
        ...
        <p>L'OpenThesaurus-ca és un diccionari català de sinònims i associacions lliure.
        ...
        <p>Qualsevol qui ho desitgi pot col·laborar en l'Openthesaurus-ca, corregir errors o afegir nous conceptes. La funció de cerca mostra tots els sentits assignats a una paraula. Podeu corregir els significats individuals, suprimir les paraules incorrctes o afegir-ne de noves. Teniu tots els detalls a les <a href="faq">PMF</a>.</p>


        <h2>Llicència</h2>

        <p>Les <strong>dades</strong> de l'Openthesaurus-ca es troben disponibles via l'<a href="api">API</a> i <a href="download">baixada</a> sota els termes de la
          ...
          els termes de la mateixa llicència i s'indiqui clarament la font de les dades amb un enllaç a http://openthesaurus.softcatala.org.</p>
        ...
        <p>El <strong>codi font del lloc web</strong> es troba disponible al <a href="https://github.com/jmontane/openthesaurus">github de Softcatalà</a>, i es basa en el codi de l'<a href="https://github.com/danielnaber/openthesaurus">Openthesaurus alemany original</a>
          ...
          Aquest servidor (http://openthesaurus.softcatala.org) té instal·lada la versió <g:meta name="app.version"/>.
        ...
        <h2>Comunitat i notícies de l'Openthesaurus-ca</h2>

        <ul>
            <li><a href="newsletter">Llista de l'OpenThesaurus-ca</a></li>
